...
def usage():
    print("USAGE  pmc_abstracts.py <root> <fileid_expr>", file=sys.stderr)
    print(
...
if __name__ == "__main__":
    ...
    for article in pmcCorpus.articles():
        ...
        #  for para in article.get_paras():
        #      print("  " + para)
        #  print()

        for rid, entry in article.get_bibliography().entries.items():
            print(rid)
            print(entry.citationStr)
